...
- `reject_limit`: Cuando el usuario rechaza la pregunta sobre un límite. Palabras clave: "no", "para nada", "no me interesa". Usá `reply_text` cortés.
